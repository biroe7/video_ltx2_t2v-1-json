# video_ltx2_t2v-1-json

Dockerized ComfyUI workflow: video_ltx2_t2v (1).json
...
docker build -t video_ltx2_t2v-1-json .

# Run the container
docker run -p 8188:8188 video_ltx2_t2v-1-json
```
